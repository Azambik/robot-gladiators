...
// You can also lo multiple values at once like thi console.log(playerName, playerAttack, playerHealth);
...
endGame;
  ...
  var endGame = function() {
      ...
      if (playerHealth > 0 ) {
          window.alert("Great job, you've suvived the game! you now have a score of " + playerMoney + ".")
      }
      else{
